...
-- 11.
-- Verifying if the View was created 
SELECT *
FROM sys.objects
...
WHERE table_name = 'percent_population_vaccinated';
...
BEGIN
    ...
    PRINT 'A visualização percent_population_vaccinated não existe no banco de dados.';
END;
